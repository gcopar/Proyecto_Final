...
void registerUser() { // FunciÃ³n para registrar un nuevo usuario
    User newUser;
...
bool verifyUser(const string& username, const string& password) {  // FunciÃ³n para verificar las credenciales del usuario
